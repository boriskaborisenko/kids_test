...
function preload ()
{
    this.load.image('ball', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Sun_symbol.svg/200px-Sun_symbol.svg.png');
    this.load.spritesheet('dragcircle', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Sun_symbol.svg/200px-Sun_symbol.svg.png', { frameWidth: 16 });
}
